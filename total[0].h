 if((x>=parcours[b][distans[b]+total[0]].x)&&(x<=parcours[b][distans[b]+total[0]].x+dimCarre)&&(y>=parcours[b][distans[b]+total[0]].y)&&(y<=parcours[b][distans[b]+total[0]].y+dimCarre))
                                                    {
                                                    ...
                                                    printf("%d  %d\n\n",parcours[b][distans[b]+total[0]].x,parcours[b][distans[b]+total[0]].y);
