                                                           if((x>=parcours[b][distans[b]+total[1]].x)&&(x<=parcours[b][distans[b]+total[1]].x+dimCarre)&&(y>=parcours[b][distans[b]+total[1]].y)&&(y<=parcours[b][distans[b]+total[1]].y+dimCarre))
                                                            {
                                                    ...
                                                    printf("%d  %d\n\n",parcours[b][distans[b]+total[1]].x,parcours[b][distans[b]+total[1]].y);
